...
;(function(factory) {
    ...
    Slick.prototype.destroy = function(refresh) {
        ...
        if (_.$slides) {
            ...
            _.$slides
                .removeClass('slick-slide slick-active slick-center slick-visible slick-current slick-next-center slick-prev-center')
    ...
    Slick.prototype.setSlideClasses = function(index) {
        ...
        allSlides = _.$slider
            .find('.slick-slide')
            .removeClass('slick-active slick-center slick-current slick-next-center slick-prev-center')
        ...
        if (_.options.centerMode === true) {
            ...
            if (_.options.infinite === true) {
                ...
                if (index === 0) {
                    ...
                    allSlides
                        .eq(allSlides.length - 1 - _.options.slidesToShow)
                        .next().addClass('slick-next-center');
                    allSlides
                        .eq(allSlides.length - 1 - _.options.slidesToShow)
                        .prev().addClass('slick-prev-center');
...
jQuery(document).ready(function ($) {
	...
	$('.gallery-slider .slide').each(function (i, elem) {
		...
		slide.index = $(this).index(), slide.body = $(this);
		allSlides[i] = slide;
	});
	...
	/*$('.title-slider__list').on('beforeChange', function(){
 	console.log('beforeChange');
 	$('.title-slider__item').removeClass('slick-prev-center');
 	$('.title-slider__item').removeClass('slick-next-center');
 });
 $('.title-slider__list').on('afterChange', function(){
 	console.log('afterChanges');
  	$('.title-slider__list .slick-center').prev().addClass('slick-prev-center');
 	$('.title-slider__list .slick-center').next().addClass('slick-next-center');
 });*/
});
"use strict";
"use strict";